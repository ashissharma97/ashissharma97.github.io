...
(async function getMediumPosts() {
  ...
  for (let i = 0; i < len; i++) {
    document.getElementById(
      "index-blogs-section"
    ).innerHTML += `<div class="card-container"> <a href="${sortedJson[i].link}"> <div class="card-image"><img src="${sortedJson[i].image}" alt="a brand new sports car" /> </div> <div class="card-body"><h1> ${sortedJson[i].title} </h1> </div> </a> </div>`;
  }
})();
